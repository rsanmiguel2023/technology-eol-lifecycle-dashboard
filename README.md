...
This project is intended to be published using a realistic branch workflow:

```text
feat/* branches -> dev -> main
```
...
- `feat/etl-modeling`
- `feat/eol-statistical-analysis`
- `feat/streamlit-dashboard`
- `feat/powerbi-export-layer`
- `feat/documentation-polish`

See `GITHUB_STEP_BY_STEP.md` and `docs/GIT_WORKFLOW.md` for the full push sequence.
